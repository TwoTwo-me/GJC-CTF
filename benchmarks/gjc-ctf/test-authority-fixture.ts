...
export function authorizedVersionStatsRequest() {
	...
	const implementationIdentity = {
		harnessSourceDigest: digest("harness-source"),
		harnessBuildDigest: digest("harness-build"),
		toolchainDigest: digest("toolchain-closure"),
		capabilityClosureDigest: digest("capability-closure"),
	};
	const reportUnsigned: Omit<MetricsReportV1, "fingerprint"> = { metricsSchemaVersion: "ctf-metrics-1" as const, benchmarkId: manifest.benchmarkId, benchmarkLockDigest: lock.lockDigest, implementationIdentity, calibrationDigest: calibration.calibrationDigest, eligibleChallengeIds: ["fixture-challenge"], createdAt: "2026-01-01T00:00:00.000Z", repeatCount: 5 as const, seedSchedule: seeds, seeds: seeds["fixture-challenge"], runs, passAt1: 0, passAt3: 0, categoryAggregates: [{ category: "fixture", numerator: 0, denominator: 1, excludedCount: 0, unknownCount: 0 }], p50WallTimeMs: 100, p95WallTimeMs: 100, manualInterventionCount: 0, unknownCount: 0, targetPassCount: 0, floorPassCount: 0, achievedPassCount: 0 };
